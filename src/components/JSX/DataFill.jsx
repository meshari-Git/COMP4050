...
class DataFill extends Component {
  ...
  submitData(event) {
    ...
    url.searchParams.set(
      "chosenUserID",
      this.chosenUserID.value ? this.chosenUserID.value : "null"
    );
        ...
        <form onSubmit={(a) => this.submitData(a)}>
          ...
          <div className="form-group">
            ...
            <select
              ...
              id="jobStatusInput"
              ref={(input) => (this.jobStatus = input)}
            >
              <option>1</option>
              <option>2</option>
              <option>3</option>
          ...
          {this.state.type === "/edit" && (
            <div className="form-group">
              ...
              <input
                type="text"
                className="form-control"
                id="jobChosenUserIDInput"
                ref={(input) => (this.chosenUserID = input)}
          ...
          <span>
            <button type="submit" className="btn btn-primary btn-lg active">
              {this.state.type === "/edit" ? "Apply" : "Create"}
            </button>
            <Link to="/dashboard">
              <button className="btn btn-danger btn-lg active">Cancel</button>
            </Link>
          </span>
        </form>
      </div>
